...
export const TERRAIN_SIZE = 200; // Size of the terrain
export const SEGMENTS = 100; // Number of segments in the terrain
export const NOISE_SCALE = 0.1; // Scale factor for noise
